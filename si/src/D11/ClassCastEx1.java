...
public class ClassCastEx1 {
	...
	public static void main(String[] args) {
		/* 일반적으로 =을 기준으로 왼쪽과 오른쪽은 같은 타입이여야 한다.
		...
		double num2 = num;
		//num와 num2가 다른 자료형이고, num2의 자료형인 double이 intfh
		...
		P2 parent1 = new C2();
		parent1.print();
		//C2를 이용하여 객체를 만들었지만 P2에는 hello 메소드가없기 떄문에 호출할 수 없다
//		parent.hello();
		C2 child1 = new C2();
		P2 parent2 = child1;
		parent2.print();
		...
		//안되는 경우 : 부모 클래스로 객체를 만들어서 형변환하는 경우
		/*C2 child3 = (C2)new P2();
		P2 parent3 = new P2();
		C2 child4 = (C2)parent3;
		child3.print();*/
		//조건부로 가능한 경우 : 자식 클래스로 객체를 만들어서 부모 클래스로 형변환한 
		//					 부모 객체인 경우 명시적으로 가능
		P2 parent5 = new C2();
