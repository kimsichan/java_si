...
public class ForLCMEx1 {
	...
	public static void main(String[] args) {
		/*두 정스의 최소 공배수를 구하는 코드를 for문을 이용하여 작성하세요.
		 ...
		 *          방법1은 무조건 1씩 증가하기 떄문에 20000번을 해야 한다.
		...
		/* 방법2 : num1 부터 시작해서 num1 * num2까지 num1씩 증가
		 * 반복횟수 : i는 num1 부터 시작해서 num1 * num2까지 num1씩 증가
