...
class ExdTvReomteCon implements ExdTvRemoteController{
	...
	public ExdTvReomteCon(int maxVolumn, int maxChannel) {
		this.maxChannel = maxChannel;
		this.maxVolumn = maxVolumn;
	}
	
}
class ExdLGTvReomteCon extends ExdTvReomteCon{
	public final static String LOGO = "LG";
	public ExdLGTvReomteCon(int maxVolumn, int maxChannel) {
		super(maxVolumn, maxChannel);
	}
}
class ExdSamSungTvReomteCon extends ExdTvReomteCon{
	public final static String LOGO = "SAMSUNG";
	public  ExdSamSungTvReomteCon(int maxVolumn, int maxChannel) {
		super(maxVolumn, maxChannel);
	}
}