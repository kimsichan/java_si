...
//	System.out.println(sum2())//에러 발생 : 매개변수가 없어서
	 ...
	 * 메소드명 : printInfo
	 * */
	public static void printInfo(int grade, int classNum, int num, String name,
			                      String ... nickname) {
...
//	public static void printInfo2(int grade, int classNum, int num,String ... nickname,
//			String name) {
		
//	}
	//p.130 가변 매개변수는 여러개 쓸 수 없음
//	public static void printInfo(int ...grade, String ...name) {
