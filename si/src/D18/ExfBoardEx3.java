...
public class ExfBoardEx3 {
	...
	public static void main(String[] args) {
		...
		//게시글 리스트 생성
		List<ExfBoard2> list = new ArrayList<ExfBoard2>();
		String [] strMenu = {
				"1. 게시글 등록",
				"2. 게시글 확인",
				"3. 게시글 수정",
	...
	public static void register(List<ExfBoard2> list, Scanner scan) {
	...
	public static void modify(List<ExfBoard2>list, Scanner scan) {
		//수정할 게시글 정보를 입력
	...
	public static void delete(List<ExfBoard2>list, Scanner scan) {
		//게시글 번호를입력
