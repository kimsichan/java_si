...
public class MathodSumEx2 {

	public static void main(String[] args) {
		/* 1부터 10까지 합을 출력한느 코드를 메소드를 이용하여 작성해보세요
		 * */
		//sumAll1은 1부터 10까지 합이 고정이기 떄문에 5부터 10까지 합을 구할수 없다
		sumAll1();
		//sumAll2는 sumAll1보다는 낫다. 1에서 5까지의 합을 구할수 있다.
		//5에서 10까지의 합을 구할수는 없다.
		sumAll2(10);
		//1에서 10까지의 합과 21에서 30까지의 합을 더한 값을 구할 때 사용할수는 없다.
		sumAll3(1,10);
		int begin = 1, end = 10;
	...
	/* 기능 :1부터 10까지 합을 콘솔에 출력하는 메소드(1과10 고정)
	 * 매개변수 : 없음 
	 * 리턴타입 : 없음 => void
	 * 메소드명 :sumAll1
	 *  */
