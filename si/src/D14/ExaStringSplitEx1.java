...
public class ExaStringSplitEx1 {
	...
	public static void main(String[] args) {
		 ...
		 * - 문자열에서 구분자를 기본으로 배열을 만들어 주는 메소드
		 ...
		 * - 문자열이 끝부분이 suffix로 끝나는지 알려주는 메소드로
		 *   suffix로 끝나면 true, 아니면 false 를 알려줌
		 * */
	...
	if(img1.endsWith(".jpg")|| img1.endsWith(".bmp")){
		...
		/* boolean startWidth(String prefix)
		 * - 문자열이 끝부분이 prefix로 끝나는지 알려주는 메소드로
		 *   prefix로 끝나면 true, 아니면 false 를 알려줌
		 * */
