...
- 댓글 기능 
- 좋아요, 싫어요 기능
- 일반, 스포츠, 연애 뉴스를 하나로 관리

- 뉴스 
 - 뉴스번호(pk), 제목, 내용, 기자번호(fk), 작성일, 최종수정일, 신문사, 대분류(일반/스포츠/연애),
   중분류(경제, 정치, 야구, 축구 등)
- 기자 
...
- 반응
 - 반응번호(pk), 뉴스번호(fk), 아이디(fk), 상태(좋아요, 슬퍼요, 훈훈해요)
*/
