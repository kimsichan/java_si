-- 2021160001학번 학생이 컴퓨터 개론 3분반 강의를 신청했다. 이 때 알맞은 쿼리를 작성하세요.
-- insert into course(co_st_num, co_su_num) values(2021160001,1);

-- 2021160123학번 학생이 컴퓨터 개론 3분반 상의를 신청했다. 이 때 알맞은 쿼리를 작성하세요.
insert into coures(co_st_num, co_su_num) 
select 2021160015, su_num from subject where su_class_num = 3 and su_title = '컼퓨터 개론';
...
select count(*) as '컴개론 3분반 현재인원' from coures
