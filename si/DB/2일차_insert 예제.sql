...
-- 	values('2021160050', 'pwkim', 'kimid', '김영희','021225-4654321');    
-- insert into student 
-- 	values(2021123005, 'park', 'parkpw', '박철수', '021221-4443332'),
-- 	(2021456005, 'parkid', 'parkpw', '박수철', '020122-1113332'); 
SELECT * FROM university_si.student;
...
-- insert into subject (su_code,su_title) values('MSC002','컴퓨터 개론');
...
-- insert into course(co_st_num, co_su_num) values(202116012,1);
